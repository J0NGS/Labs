...
#include <random>           // inclui função rand para gerar números aleatorios
...
HDC hdc;
COLORREF color = RGB(255,255,255);             //coordenada para definir a cor do pixel

// -----------------------------------------------------------------------
// funções do jogo

//Função para gerar um número aleatório entre 0 e 960
int NumeroAleatorio() {
    random_device rd;
    mt19937 mt(rd());
